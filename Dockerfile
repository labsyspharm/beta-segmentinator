...
RUN apt-get install -y python3.10-full python3-pip git && git clone -b gmm https://github.com/labsyspharm/beta-segmentinator.git && pip install -r beta-segmentinator/requirements.txt
